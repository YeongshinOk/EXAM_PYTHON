...
print(f'alist => {type(atuple)}, {len(atuple)}개')
print(f'alist => {type(adict)}, {len(adict)}개')
print(f'alist => {type(aset)}, {len(aset)}개')
print(f'alist => {type(astr)}, {len(astr)}개')
...
# ------------------------------------------------------------------
# 원소/요소 읽기/수정/삭제/추가 ===> 인덱스 X, 키X ==> 메서드 제공
# ------------------------------------------------------------------
